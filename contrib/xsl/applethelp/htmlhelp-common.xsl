...
For the applet-style help to function, you must first copy the contents of the
...
C:\Program Files\HTML Help Workshop\java, not the folder (so HHCtrl.class and
