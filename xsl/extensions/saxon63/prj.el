...
\"}\"'>'n '>'n'>")))
 ...
 '(jde-compile-option-directory "/sourceforge/docbook/xsl/extensions/saxon63/.classes" t)
 ...
 '(jde-compile-option-classpath (quote ("/sourceforge/docbook/xsl/extensions/saxon63/.classes" "/usr/local/java/saxon-6.3/saxon.jar" "/usr/local/jaxp-1.1/jaxp.jar" "/usr/local/jaxp-1.1/crimson.jar")) t)
