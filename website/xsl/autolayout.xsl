...
<xsl:output method="xml" indent="no"
            doctype-public="-//Norman Walsh//DTD Website Autolayout V2.4.0//EN"
            doctype-system="http://docbook.sourceforge.net/release/website/2.4.0/schema/dtd/autolayout.dtd"
/>
